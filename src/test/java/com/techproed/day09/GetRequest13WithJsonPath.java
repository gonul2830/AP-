...
public class GetRequest13WithJsonPath extends TestBaseDummy {
  /*
...
"profile_image": "" }
    ...
    public  void test() {
        ...
        Assert.assertEquals(
                ((Map)expectedDataMap.get("employe11")).get("id"),json.getInt("data[10].id"));
        Assert.assertEquals(
                ((Map)expectedDataMap.get("employe11")).get("employee_name"),json.getString("data[10].employee_name"));

        Assert.assertEquals(
                ((Map)expectedDataMap.get("employe11")).get("employee_salary"),json.getInt("data[10].employee_salary"));
        Assert.assertEquals(
                ((Map)expectedDataMap.get("employe11")).get("employee_age"),json.getInt("data[10].employee_age"));

        Assert.assertEquals(
                ((Map)expectedDataMap.get("employe11")).get("profile_image"),json.getString("data[10].profile_image"));
